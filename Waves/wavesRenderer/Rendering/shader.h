...
public:
	...
	Shader(const char* vertexPath, const char* fragmentPath)
	{
		...
		glAttachShader(objectID, vertex);
		glAttachShader(objectID, fragment);
	...
	// To keep from deleting when pushing ID into renderer
	/*~Shader()
	{
...
private:
	// utility: check shader compilation/linking errors.
